...
import { useDeleteLessonDay } from "hooks";
...
const DeleteLessonDay = () => {
  ...
  const deleteLessonDay = useDeleteLessonDay({
    onSuccess: () => {
...
export default DeleteLessonDay;

...
import { useDeleteGroupType } from "hooks";
...
const DeleteGroupType = () => {
  const dispatch = useDispatch();
  const {
    deleteGroupType: { data, open },
  ...
  return (
    <ActionModal
      ...
      buttonLoading={deleteGroupType.isLoading}
      text={
        <div>
          <p>Are you sure?</p>
...
export default DeleteGroupType;

...
import { AntdUserProfile, Cell, TableHeading } from "components";
import { bgColors } from "styles/theme";
import { ArrowSvg } from "components";
import Image from "next/image";
import { usePageDataMemo } from "hooks";
import { IPotentialFailReview } from "types/potentialFail/potentialFailRequest";

const Columns = ({ expandedRowKeys }: { expandedRowKeys: any }) => {
    ...
    return [
      {
        ...
        dataIndex: "progress",
        render: (value: any, record: IPotentialFailReview, index: number) => {
          return (
            <AntdUserProfile
              disabled
              props={record}
      ...
      {
        title: <TableHeading>In percent</TableHeading>,
        dataIndex: "createdBy",

...
import { EColumns } from "./type";
import ProductCell from "./components/product";

export const Columns = ({ products }: EColumns) => {
    ...
    () => [
      {
        ...
        render: (value: any, record: any, index: number) => {
          ...
          const user = productAndServiceIncome?.user;
          return (
            <AntdUserProfile
              props={record}
      ...
      },
      {
        ...
        dataIndex: "productAndServiceIncome",
        render: (value: any, record: any, index: number) => {
          const productAndServiceIncome: IProductAndServiceIncome = value;
          return (
            <ProductCell
              productAndServiceIncome={productAndServiceIncome}
              products={products}
              selects={selects}
            />
          );

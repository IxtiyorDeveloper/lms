...
export const AdministratorLC = (data: any, date: string) => {
  return (
    <>
      ...
      <p>
        ...
        <b>Администратора</b> заключен между:
      </p>
      <p className="s-flex">
      ...
      <p className="s-flex">
        ...
        <p className="fill">
          Работник принимается на должность <b>Администратора.</b> Перечень
      ...
      <h1 className="c-title">ДОЛЖНОСТНЫЕ ОБЯЗАННОСТИ АДМИНИСТРАТОРА</h1>

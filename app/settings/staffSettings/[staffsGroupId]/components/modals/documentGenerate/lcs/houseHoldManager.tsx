...
export const HouseHoldManagerLC = (data: any, date: string) => {
  return (
    <>
      ...
      <p>
        ...
        <b>Менеджера Хозяйственного отдела</b> заключен между:
      </p>
      <p className="s-flex">
      ...
      <p className="s-flex">
        ...
        <p className="fill">
          ...
          <b>Менеджера Хозяйственного отдела.</b> Перечень основных трудовых
      ...
      <p className="s-flex">
        ...
        <p className="fill">
          ...
          Архитектуры и строительства по соглашению с Работником. При этом
          Работник обязуется добросовестно относиться к прохождению обучения, к
          получению знаний и навыков. Работник обязуется полностью взять на себя
          все обязанности п. 8.3 если Работник по каким-либо причинам не сможет
          сдать и пройти экзамен, по которому он/она проходил(а) обучение.
        </p>
      </p>
      <p className="s-flex">
      ...
      <h1 className="c-title">
        ДОЛЖНОСТНЫЕ ОБЯЗАННОСТИ Менеджера Хозяйственного отдела
      </h1>
      <p>Специалист АХО обязан:</p>
      <p className="s-flex">
        <div className="number">(A)</div>
        <p className="fill">
          Контролировать сотрудников АХО что бы они выполняли свои должностные
          обязанности, указанные в Трудовом договоре (с сотрудниками АХО
          Приложение №1) с пункта A до пункта К. Настоящий пункт является
          основной обязанностью данной должности по сколько она включает в себя
          управление и контроль над всеми обязанностями сотрудниками АХО.
        </p>
      </p>
      <p className="s-flex">
        <div className="number">(B)</div>
        <p className="fill">Проводить тренинги для сотрудников АХО.</p>
      </p>
      <p className="s-flex">
        <div className="number">(C)</div>
        <p className="fill">
          Подготавливать и улучшать действующие и/или новые материалы для
          улучшения уровня труда.
        </p>
      </p>
      <p className="s-flex">
        <div className="number">(D)</div>
        <p className="fill">
          Проводить собеседование для подбора сотрудников АХО.
        </p>
      </p>
      <p className="s-flex">
      ...
      <p className="s-flex">
        ...
        <p className="fill">
          Контролировать весь процесс хозяйственной работы.
        </p>
      </p>
      <p className="s-flex">
        <div className="number">(H)</div>
        <p className="fill">
          Составлять и/или обновлять материалы хозяйственной работы.
        </p>
      </p>
      <p className="s-flex">
        <div className="number">(I)</div>
        <p className="fill">
          Ежедневно проверять наличии труд-инструментов и материалов
      ...
      <p className="s-flex">
        ...
        <p className="fill">
          ...
          принадлежащее Работодателю. При этом, Менеджер Хозяйственного отдела

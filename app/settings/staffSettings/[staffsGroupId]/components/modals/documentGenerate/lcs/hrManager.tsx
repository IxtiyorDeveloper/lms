...
export const HRManagerLC = (data: any, date: string) => {
  return (
    <>
      ...
      <p>
        ...
        <b>Менеджера отдела HR</b> заключен между:
      </p>
      <p className="s-flex">
      ...
      <p className="s-flex">
        ...
        <p className="fill">
          Работник принимается на должность <b>Менеджера отдела HR.</b> Перечень
      ...
      <h1 className="c-title">ДОЛЖНОСТНЫЕ ОБЯЗАННОСТИ Менеджера отдела HR</h1>
      <p className="s-flex">
        <div className="number">(A)</div>
        <p className="fill">
          Контролировать своих ассистентов что бы они выполняли свои должностные
          обязанности, указанные в Трудовом договоре (с HR Ассистентами
          Приложение №1) с пункта A до пункта L. Настоящий пункт является
          основной обязанностью данной должности по сколько она включает в себя
          управление и контроль над всеми обязанностями HR-ассистентов.
        </p>
      </p>
      <p className="s-flex">
        <div className="number">(B)</div>
        <p className="fill">Проводить тренинги для HR-ассистентов.</p>
      </p>
      <p className="s-flex">
        <div className="number">(C)</div>
        <p className="fill">
          Подготавливать и улучшать действующие и/или новые материалы для
          улучшения уровня Рекрутинга.
        </p>
      </p>
      <p className="s-flex">
        <div className="number">(D)</div>
        <p className="fill">
          Проводить собеседование для подбора всех сотрудников.
        </p>
      </p>
      <p className="s-flex">
      ...
      <p className="s-flex">
        ...
        <p className="fill">Контролировать весь процесс рекрутинга.</p>
      </p>
      <p className="s-flex">
        <div className="number">(H)</div>
        <p className="fill">Составлять и/или обновлять материалы рекрутинга.</p>
      </p>
      <p className="s-flex">
        <div className="number">(I)</div>
        <p className="fill">
          Ежедневно проверять персональный кабинет HR-ассистентов чтобы они
          правильно пользовались персональным кабинетом;
        </p>
      </p>
      <p className="s-flex">
      ...
      <p className="s-flex">
        ...
        <p className="fill">Тесно работать со своими помощниками.</p>
      </p>
      <p className="s-flex">
        <div className="number">(M)</div>
        <p className="fill">
          Отслеживать ситуацию на рынке труда. На основе этого анализа
          формировать оптимальный уровень зарплаты на разные должности.
        </p>
      </p>
      <p className="s-flex">
        <div className="number">(N)</div>
        <p className="fill">Формировать кадровый резерв.</p>
      </p>
      <p className="s-flex">
      ...
      <p className="s-flex">
        ...
        <p className="fill">
          Продумывать систему мотивации для коллектива, отслеживать и устранять
          эмоциональное выгорание сотрудников Общества.
        </p>
      </p>
      <p className="s-flex">
        <div className="number">(Q)</div>
        <p className="fill">Анализировать рынок образовательных услуг.</p>
      </p>
      <p className="s-flex">
        <div className="number">(R)</div>
        <p className="fill">Координировать работу по обучению специалистов.</p>
      </p>
      <p className="s-flex">
        <div className="number">(S)</div>
        <p className="fill">Заниматься кадровыми перестановками.</p>
      </p>
      <p className="s-flex">
      ...
      <p className="s-flex">
        ...
        <p className="fill">
          Планировать и решать трудовые вопросы, составлять и подписывать
          трудовые договоры, вести личные дела.
        </p>
      </p>
      <p className="s-flex">
        <div className="number">(V)</div>
        <p className="fill">
          Готовить предложения по распределению бюджета Общества на решение
          кадровых вопросов.
        </p>
      </p>
      <p className="s-flex">
      ...
      <p className="s-flex">
        ...
        <p className="fill">
          ...
          принадлежащее Работодателю. При этом, Менеджера отдела HR не вправе

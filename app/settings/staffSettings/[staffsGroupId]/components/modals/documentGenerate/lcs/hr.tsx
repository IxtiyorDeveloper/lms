...
export const HRLC = (data: any, date: string) => {
  return (
    <>
      ...
      <p>
        ...
        <b>HR-ассистента</b> заключен между:
      </p>
      <p className="s-flex">
      ...
      <p className="s-flex">
        ...
        <p className="fill">
          Работник принимается на должность <b>HR-ассистента.</b> Перечень
      ...
      <p className="s-flex">
        ...
        <p className="fill">
          <p>
            ...
            следующим образом: Работа осуществляется в две смены:
          </p>
          <p>с 9:00 ч. по 17:00 ч. с перерывом с 13:00 до 14:00 (1 час).:</p>
          <p>с 13:30 ч. по 20:00 ч. с перерывом с 16:30 до 17:00 (30 минут).</p>
      ...
      <h1 className="c-title">ДОЛЖНОСТНЫЕ ОБЯЗАННОСТИ HR-АССИСТЕНТА</h1>
      <p>HR-Ассистент обязан:</p>
      <p className="s-flex">

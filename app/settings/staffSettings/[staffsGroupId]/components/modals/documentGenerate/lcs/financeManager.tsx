...
export const FinanceManagerLC = (data: any, date: string) => {
  return (
    <>
      <h1 className="c-title">ТРУДОВОЙ ДОГОВОР №__</h1>
      ...
      <p>
        ...
        <b>Менеджера Финансового отдела</b> заключен между:
      </p>
      <p className="s-flex">
      ...
      <p className="s-flex">
        ...
        <p className="fill">
          Работник принимается на должность <b>Менеджера Финансового отдела.</b>{" "}
      ...
      <h1 className="c-title">
        ДОЛЖНОСТНЫЕ ОБЯЗАННОСТИ Менеджера Финансового отдела
      </h1>
      <p className="s-flex">
        <div className="number">(A)</div>
        <p className="fill">
          Контролировать Кассиров что бы они выполняли свои должностные
          обязанности, указанные в Трудовом договоре (с Кассирами Приложение №1)
          с пункта A до пункта F. Настоящий пункт является основной обязанностью
          данной должности по сколько она включает в себя управление и контроль
          над всеми обязанностями Кассиров.
        </p>
      </p>
      <p className="s-flex">
        <div className="number">(B)</div>
        <p className="fill">Проводить тренинги для Кассиров.</p>
      </p>
      <p className="s-flex">
      ...
      <p className="s-flex">
        ...
        <p className="fill">Проводить собеседование для подбора Кассиров.</p>
      </p>
      <p className="s-flex">
      ...
      <p className="s-flex">
        ...
        <p className="fill">Контролировать весь процесс финансовых операций.</p>
      </p>
      <p className="s-flex">
        <div className="number">(H)</div>
        <p className="fill">
          Составлять и/или обновлять материалы для финансового отдела.
        </p>
      </p>
      <p className="s-flex">
        <div className="number">(I)</div>
        <p className="fill">
          Ежедневно проверять персональный кабинет Кассиров чтобы они правильно
          пользовались персональным кабинетом;
        </p>
      </p>
      <p className="s-flex">
      ...
      <p className="s-flex">
        ...
        <p className="fill">
          Тесно работать со своими помощниками («Кассирами»);
        </p>
      </p>
      <p className="s-flex">
      ...
      <p className="s-flex">
        ...
        <p className="fill">
          ...
          принадлежащее Работодателю. При этом, Менеджер Финансового отдела не
          вправе сохранять какие-либо копии указанных документов.
        </p>
      </p>
      <p>

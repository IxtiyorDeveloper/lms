...
export const HouseHoldLC = (data: any, date: string) => {
  return (
    <>
      ...
      <p>
        ...
        <b>Специалиста АХО</b> (Административно-хозяйственная служба) заключен
        между:
      </p>
      <p className="s-flex">
      ...
      <p className="s-flex">
        ...
        <p className="fill">
          ...
          <b>Специалиста АХО (Административно- хозяйственная служба).</b>{" "}
      ...
      <p className="s-flex">
        ...
        <p className="fill">
          <p>
            ...
            день Работник работает:
          </p>
          <p>
            Понедельник-пятница: с 10:00 ч. по 18:00 ч. с перерывом с 13:00 до
            14:00 (1 час).
          </p>
          <p>
            Суббота: с 10:00 ч. по 16:00 ч. с перерывом с 13:00 до 14:00 (1
            час).
          </p>
        </p>
      </p>
      ...
      <h1 className="c-title">ДОЛЖНОСТНЫЕ ОБЯЗАННОСТИ СПЕЦИАЛИСТА АХО</h1>
      <p>Специалист АХО обязан:</p>
      <p className="s-flex">
        <div className="number">(A)</div>
        <p className="fill">Устанавливать причины аварий, неполадок;</p>
      </p>
      <p className="s-flex">
        <div className="number">(B)</div>
        <p className="fill">
          Выполнять работу по проведению необходимых технических расчетов;
        </p>
      </p>
      <p className="s-flex">
        <div className="number">(C)</div>
        <p className="fill">
          Разработать несложные проектные и простые схемы, обеспечивая их
          соответствие техническим заданиям, действующим стандартам и
      ...
      <p className="s-flex">
        ...
        <p className="fill">
          Осуществлять наладку, настройку, регулировку и опытную проверку
          оборудования, следить за его исправным состоянием;
        </p>
      </p>
      <p className="s-flex">
        <div className="number">(E)</div>
        <p className="fill">
          Выполнять работу по сбору, обработке и накоплению исходных материалов,
      ...
      <p className="s-flex">
        ...
        <p className="fill">
          Составлять, исходя из выполненных работ, необходимые спецификации,
          схемы, таблицы, графики и другие технические документы;
        </p>
      </p>
      <p className="s-flex">
        <div className="number">(G)</div>
        <p className="fill">
          Выполнять работу по оформлению плановой и отчетной документации,
          вносить необходимые изменения и исправления в техническую документацию
          в соответствии с решениями, принятыми при рассмотрении и обсуждении
          выполняемой работы;
        </p>
      </p>
      <p className="s-flex">
        ...
        <p className="fill">
          Систематизировать, обрабатывать и подготавливать данные для
          составления отчетов о работе;
        </p>
      </p>
      <p className="s-flex">

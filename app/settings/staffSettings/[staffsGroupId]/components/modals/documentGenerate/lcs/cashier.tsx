...
export const CashierLC = (data: any, date: string) => {
  return (
    <>
      ...
      <p>
        Настоящий трудовой договор (<b>«Договор»</b>) на позицию <b>Кассира</b>{" "}
        заключен между:
      </p>
      <p className="s-flex">
      ...
      <p className="s-flex">
        ...
        <p className="fill">
          Работник принимается на должность <b>Кассира.</b> Перечень основных
      ...
      <p className="s-flex">
        ...
        <p className="fill">
          ...
          <p>
            с 8:30 ч. по 20:15 ч., при этом перерыв для отдыха и питания с 12:30
            до 13:00 (30 минут) с 1 до 10 числа месяца.
          </p>
          <p>
            c 13:30 ч. по 20:15 ч. начиная с 11 числа месяца по 24 число месяца,
            при этом перерыв с 16:30 до 17:00 (30 минут).
          </p>
          <p>
            При этом, выходными днями являются воскресенье и дни с 25 числа
            конца месяца до 1 числа нового месяца.
          </p>
        </p>
      </p>
      <p className="s-flex">
      ...
      <p className="s-flex">
        ...
        <p className="fill">
          Работник выплачивает Работодателю неустойку в размере 25 БРВ в течение
      ...
      <p className="s-flex">
        ...
        <p className="fill">
          Работодатель выплачивает Работнику неустойку в размере 25 БРВ в
      ...
      <h1 className="c-title">ДОЛЖНОСТНЫЕ ОБЯЗАННОСТИ КАССИРА</h1>
      <p>Кассир обязан:</p>
      <p className="s-flex">
        <div className="number">(A)</div>
        <p className="fill">
          Всегда с уважением и с улыбкой встречать посетителей и студентов;
        </p>
      </p>
      <p className="s-flex">
        <div className="number">(B)</div>
        <p className="fill">Принимать оплату;</p>
      </p>
      <p className="s-flex">
        <div className="number">(C)</div>
        <p className="fill">Готовить ежедневные отчеты;</p>
      </p>
      <p className="s-flex">
        <div className="number">(D)</div>
        <p className="fill">Принимать книги и тетради;</p>
      </p>
      <p className="s-flex">

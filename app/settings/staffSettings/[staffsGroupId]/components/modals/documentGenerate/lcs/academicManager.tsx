...
export const AcademicManagerLC = (data: any, date: string) => {
  ...
  return (
    <>
      ...
      <p>
        ...
        <b>Менеджера академического отдела</b> заключен между:
      </p>
      <p className="s-flex">
      ...
      <p className="s-flex">
        ...
        <p className="fill">
          ...
          <b>Менеджера академического отдела.</b> Перечень основных трудовых
      ...
      <div className="end" style={{ marginBottom: "600px" }}>
      ...
      <h1 className="c-title">
        ДОЛЖНОСТНЫЕ ОБЯЗАННОСТИ Менеджера академического отдела
      </h1>
      <p>Преподаватель английского языка обязан:</p>
      <p className="s-flex">
        <div className="number">(A)</div>
        <p className="fill">
          Контролировать Преподавателей английского языка и Ассистентов
          преподавателей что бы они выполняли свои должностные обязанности,
          указанные в Трудовом договоре (с преподавателями английского языка и
          ассистентами преподавателей Приложение №1) с пункта A до пункта Y.
          Настоящий пункт является основной обязанностью данной должности по
          сколько она включает в себя управление и контроль над всеми
          обязанностями преподавателей и ассистентов преподавателей
        </p>
      </p>
      <p className="s-flex">
        <div className="number">(B)</div>
        <p className="fill">
          Проводить тренинги для преподавателей и ассистентов преподавателей.
        </p>
      </p>
      <p className="s-flex">
        <div className="number">(C)</div>
        <p className="fill">
          Подготавливать и улучшать действующие и/или новые учебные материалы
          для улучшения уровня преподавания.
        </p>
      </p>
      <p className="s-flex">
        <div className="number">(D)</div>
        <p className="fill">
          Проводить собеседование для подбора преподавателей и ассистентов
          преподавателей.
        </p>
      </p>
      <p className="s-flex">
      ...
      <p className="s-flex">
        ...
        <p className="fill">
          Контролировать весь процесс ежемесячных экзаменов
        </p>
      </p>
      <p className="s-flex">
        <div className="number">(H)</div>
        <p className="fill">Составлять и/или обновлять материалы экзамена.</p>
      </p>
      <p className="s-flex">
        <div className="number">(I)</div>
        <p className="fill">
          Ежедневно проверять персональный кабинет преподавателей чтобы они
          ставили оценки и делали «Attendance»;
        </p>
      </p>
      <p className="s-flex">
      ...
      <p className="s-flex">
        ...
        <p className="fill">
          Тесно работать со своими помощниками («Head Teachers»);
        </p>
      </p>
      <p className="s-flex">
      ...
      <p className="s-flex">
        ...
        <p className="fill">
          ...
          принадлежащее Работодателю. При этом, Менеджер академического отдела
          не вправе сохранять какие-либо копии указанных документов.
        </p>
      </p>
      <p>

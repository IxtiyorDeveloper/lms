...
export const TeacherLC = (data: any, date: string) => {
  return (
    <>
      ...
      <p>
        ...
        <b>Преподавателя английского языка</b>
      </p>
      <p className="s-flex">
      ...
      <p className="s-flex">
        ...
        <p className="fill">
          ...
          <b>Преподавателя английского языка</b>. Перечень основных трудовых
      ...
      <p className="s-flex">
        ...
        <p className="fill">
          <p>
            Работнику устанавливается рабочая неделя в зависимости от количества
            обучаемых групп. Группы могут поставить в четные дни недели
            (Вторник/Четверг/Суббота) или в нечетные дни недели
            (Понедельник/Среда/Пятница). Выходным днем является воскресенье. В
            рабочий день Работник работает:
          </p>
          <p>
            с 07:30 по 13:30 – для работающих в дневное время, при этом перерыв
            даётся между занятиями по 10 минут.
          </p>
          <p>
            с 14:00 по 20:00 – для работающих в вечернее время, при этом перерыв
            даётся между занятиями по 10 минут.
          </p>
        </p>
      </p>
      ...
      <p className="s-flex pl">
        ...
        <p className="fill">
          <p className="mb-space">
            ...
            Работника. Если возмещение затрат не выполнено в срок, на Работника
            по Договору начисляется пеня в размере 1 % от суммы понесенных
            затрат Работодателя за обучение Работника за каждый календарный день
            просрочки исполнения обязанности по возмещению. В случае возмещения
            расходов в
          </p>
          иностранной валюте Работник производит по курсу, установленному
          Центральным банком Республики Узбекистан на день оплаты.
        </p>
      </p>
      <p className="s-flex">
      ...
      <p className="s-flex">
        ...
        <p className="fill">
          <p className="mb-space">
            ...
            дискриминация и принудительный труд в какой-либо
          </p>
          форме, в том числе не допускается проявлять действия харассмента на
          работе.
        </p>
      </p>
      <p className="s-flex">
      ...
      <h1 className="c-title">
        ДОЛЖНОСТНЫЕ ОБЯЗАННОСТИ ПРЕПОДАВАТЕЛЯ АНГЛИЙСКОГО ЯЗЫКА
      </h1>
      <p>Преподаватель английского языка обязан:</p>
      <p className="s-flex">
        <div className="number">(A)</div>
        <p className="fill">Максимально подготовиться к урокам;</p>
      </p>
      <p className="s-flex">
        <div className="number">(B)</div>
        <p className="fill">
          Постоянно работать над собой, применять на практике советы
          Академического директора и Главного учителя (Head teacher) и
          стремиться к непрерывному развитию;
        </p>
      </p>
      <p className="s-flex">
        <div className="number">(C)</div>
        <p className="fill">
          Пользоваться учебниками и материалами «Navigate» для «General English»
          уровней и «Expert 7.5» для уровня «IELTS»;
        </p>
      </p>
      <p className="s-flex">
      ...
      <p className="s-flex">
        ...
        <p className="fill">
          Во время «Preparation Lesson» перед экзаменом повторить все темы со
          студентами во время урока, которые были пройдены на соответствующем
          уровне;
        </p>
      </p>
      <p className="s-flex">
        ...
        <p className="fill">
          Своевременно проверять часть письменного компонента экзамена «Writing»
          онлайн и вносить результаты в систему в своем персональном кабинете
          (Раздел My Groups' Exams);
        </p>
      </p>
      <p className="s-flex">
        <div className="number">(G)</div>
        <p className="fill">
          Ежедневно проверять персональный кабинет и «Staff App» чтобы ставить
          оценки и делать «Attendance»;
        </p>
      </p>
      <p className="s-flex">
        <div className="number">(H)</div>
        <p className="fill">
          Заполнять во время урока при студентах посещаемость для каждой группы;
        </p>
      </p>
      <p className="s-flex">
      ...
      <p className="s-flex">
        ...
        <p className="fill">
          Вести урок только стоя на ногах, за исключением тех случаев, когда
          студенты смотрят видео, делают «Speaking Pair-Work» и «Listening»;
        </p>
      </p>
      <p className="s-flex">
        <div className="number">(L)</div>
        <p className="fill">
          Не пользоваться мобильными устройствами во время урока;
        </p>
      </p>
      <p className="s-flex">
      ...
      <p className="s-flex">
        ...
        <p className="fill">
          Своевременно информировать своего помощника («Academic Support») о
          невыполнении домашнего задания студентом;
        </p>
      </p>
      <p className="s-flex">
        <div className="number">(P)</div>
        <p className="fill">
          В конце каждого месяца совместно со своим помощником («Academic
          Support») составлять список «PODO» среди студентов (список студентов с
          плохой посещаемостью, плохой успеваемостью и неудовлетворительным
          поведением);
        </p>
      </p>
      <p className="s-flex">
        ...
        <p className="fill">
          Проводить беседу с новым студентом после его первого урока;
        </p>
      </p>
      <p className="s-flex">
        <div className="number">(R)</div>
        <p className="fill">
          После проведения беседы с новым студентом, оставить комментарий на
          обратной стороне карточки FULL PAID и отправить в администрацию;
        </p>
      </p>
      <p className="s-flex">
        <div className="number">(S)</div>
        <p className="fill">
          Не впускать на урок студентов, попавших в «Black List» и отправлять в
          администрацию;
        </p>
      </p>
      <p className="s-flex">
        ...
        <p className="fill">
          Не впускать чужих студентов на урок без карточки «Full Paid» или «One
          Time»;
        </p>
      </p>
      <p className="s-flex">
        ...
        <p className="fill">
          Не иметь контакт со студентами через телефонный номер или соц. сети
          (Facebook, Instagram, Telegram и т.д.);
        </p>
      </p>
      <p className="s-flex">

...
export const ProgrammerLC = (data: any, date: string) => {
  return (
    <>
      ...
      <p>
        ...
        <b>Программиста</b> заключен между:
      </p>
      <p className="s-flex">
      ...
      <p className="s-flex">
        ...
        <p className="fill">
          Работник принимается на должность <b>Программиста.</b> Перечень
      ...
      <p className="s-flex">
        ...
        <p className="fill">
          <p>
            Работнику устанавливается рабочая неделя продолжительностью 5 (пять)
            рабочих дней. Выходными днями являются суббота и воскресенье. В
            рабочий день Работник работает:
          </p>
          <p>
            Понедельник-пятница: с 09:30 ч. по 18:30 ч. с перерывом с 12:30 до
            13:30 (1 час).
          </p>
        </p>
      </p>
      <p className="s-flex">
        ...
        <p className="fill">
          Работнику устанавливается рабочая неделя продолжительностью 5 (пять)
          рабочих дней. Выходным днем является суббота и воскресенье. В рабочий
          день Работник работает: с 10:30 ч. по 19:00 ч. с перерывом с 13:00 до
          14:00 (1 час).
        </p>
      </p>
      <p className="s-flex">
      ...
      <h1 className="c-title">ДОЛЖНОСТНЫЕ ОБЯЗАННОСТИ ПРОГРАММИСТА</h1>
      <p>Программист обязан:</p>
      <p className="s-flex">
        <div className="number">(A)</div>
        <p className="fill">
          Разработать процедуру проверки работоспособности программного
          обеспечения, сбора диагностических данных, измерения требуемых
      ...
      <p className="s-flex">
        ...
        <p className="fill">
          Осуществлять подготовку тестовых наборов данных в соответствии с
          выбранной методикой;
        </p>
      </p>
      <p className="s-flex">
        ...
        <p className="fill">
          Осуществлять проверку работоспособности программного обеспечения на
          основе разработанных тестовых наборов данных;
        </p>
      </p>
      <p className="s-flex">
        <div className="number">(D)</div>
        <p className="fill">
          Осуществлять сбор и анализ полученных результатов проверки
      ...
      <p className="s-flex">
        ...
        <p className="fill">
          Проводить анализ программного кода на соответствие требованиям по
      ...
      <p className="s-flex">
        ...
        <p className="fill">
          Регулярно проводить технические диагностики работоспособности
      ...
      <p className="s-flex">
        ...
        <p className="fill">
          Осуществлять воспроизведение дефектов, зафиксированных в базе данных
          дефектов;
        </p>
      </p>
      <p className="s-flex">
        <div className="number">(H)</div>
        <p className="fill">Устанавливать причины возникновения дефектов;</p>
      </p>
      <p className="s-flex">
        <div className="number">(I)</div>
        <p className="fill">
          Вносить изменения в программный код для устранения выявленных
          дефектов;
        </p>
      </p>
      <p className="s-flex">

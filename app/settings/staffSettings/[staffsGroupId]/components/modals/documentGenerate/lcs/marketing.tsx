...
export const MarketingLC = (data: any, date: string) => {
  return (
    <>
      ...
      <p>
        ...
        <b>Специалиста по маркетингу и мероприятий</b> заключен между:
      </p>
      <p className="s-flex">
      ...
      <p className="s-flex">
        ...
        <p className="fill">
          ...
          <b>Специалиста по маркетингу и мероприятий.</b> Перечень основных
          трудовых обязанностей Работника приводится в <b>Приложении №1</b> к
          настоящему Договору, а также определяется действующим
      ...
      <p className="s-flex">
        ...
        <p className="fill">
          <p>
            ...
            рабочих дней. Выходным днем является суббота и воскресенье. В
            рабочий день Работник работает:
          </p>
          <p>с 10:30 ч. по 19:00 ч. с перерывом с 13:00 до 14:00 (1 час).</p>
        </p>
      </p>
      <p className="s-flex">
      ...
      <p className="s-flex">
        ...
        <p className="fill">
          Работник выплачивает Работодателю неустойку в размере 45 БРВ в течение
      ...
      <p className="s-flex">
        ...
        <p className="fill">
          Работодатель выплачивает Работнику неустойку в размере 45 БРВ в
      ...
      <h1 className="c-title">
        ДОЛЖНОСТНЫЕ ОБЯЗАННОСТИ СПЕЦИАЛИСТА ПО МАРКЕТИНГУ И МЕРОПРИЯТИЙ
      </h1>
      <p>Специалист по маркетингу и мероприятий обязан:</p>
      <p className="s-flex">
        <div className="number">(A)</div>
        <p className="fill">
          Создавать и оформлять страницы в социальных сетях;
        </p>
      </p>
      <p className="s-flex">
        <div className="number">(B)</div>
        <p className="fill">Создавать и размещать публикации;</p>
      </p>
      <p className="s-flex">
        <div className="number">(C)</div>
        <p className="fill">Проводить SMM-активности;</p>
      </p>
      <p className="s-flex">
        <div className="number">(D)</div>
        <p className="fill">Настраивать таргетированную рекламу;</p>
      </p>
      <p className="s-flex">
        <div className="number">(E)</div>
        <p className="fill">Проводить анализ рынка;</p>
      </p>
      <p className="s-flex">
        <div className="number">(F)</div>
        <p className="fill">Мониторить SMM-бюджет;</p>
      </p>
      <p className="s-flex">
        <div className="number">(G)</div>
        <p className="fill">Взаимодействовать с аудиторией;</p>
      </p>
      <p className="s-flex">
        <div className="number">(H)</div>
        <p className="fill">
          Тесно работать с другими отделами для публикации и рекламирование
          ивентов, привлечение студентов, потенциальных профессионалов и др.;
        </p>
      </p>
      <p className="s-flex">
        <div className="number">(I)</div>
        <p className="fill">
          Проводить воскресные ивенты по спикингу, гостевым лекциям и разным
          мероприятиям;
        </p>
      </p>
      <p className="s-flex">

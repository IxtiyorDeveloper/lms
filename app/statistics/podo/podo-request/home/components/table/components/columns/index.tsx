...
import { EStaffType, IPodoRequest } from "types/statistics/podoRequest";
import moment from "moment";
import { myStatus } from "./components/status";

const staffType = {
  [EStaffType.SUPPORT]: "Support",
  [EStaffType.TEACHER]: "Teacher",
  [EStaffType.TEACHER_AND_SUPPORT]: "Teacher and Support",
};
    ...
    return [
      {
        ...
        dataIndex: "progress",
        render: (value: any, record: IPodoRequest, index: number) => {

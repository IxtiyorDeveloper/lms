...
const ByActiveStudentStatus = () => {
  ...
  const getAllData = () => {
    if (data?.byActiveStatus) {
      const formShare = data?.byActiveStatus;
  ...
  return (
    <Wrapper>
      <StatisticsCard title="By active students statuses" isLoading={isLoading}>
...
export default ByActiveStudentStatus;

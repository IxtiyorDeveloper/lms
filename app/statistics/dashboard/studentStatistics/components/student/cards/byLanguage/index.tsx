...
const ByNativeLanguage = () => {
  ...
  const example = _.uniqBy(data?.languageShare, "status_label");
  ...
  const getAllData = () => {
    if (data?.languageShare) {
      const formShare = data?.languageShare.filter((v) =>
...
export default ByNativeLanguage;
